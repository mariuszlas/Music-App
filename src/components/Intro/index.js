...
const ArtistInfo = () => {
    ...
    return (
        <table>
            <tbody>
            <tr><th>Courtney Barnett</th></tr>
            <tr><td>Artist Genre</td><td>indie rock</td></tr>
            <tr><td>About</td><td>Courtney Melba Barnett (born 3 November 1987) is an Australian singer, songwriter, and musician. 
